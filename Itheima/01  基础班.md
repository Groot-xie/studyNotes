...
| 属性         | 属性值                                                       | 描述                                                         |
| ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| type         | text<br />password<br />radio<br />checkbox<br />button<br />submit<br />reset<br />image<br />file<br />range<br />detetime-local | 文本<br />密码<br />单选按钮<br />复选按钮<br />普通按钮<br />提交按钮<br />重置按钮<br />提交按钮(图片格式)<br />文本域<br />进度条<br />时间轴 |
| name         | 由用户自定义                                                 | 控件的名称                                                   |
